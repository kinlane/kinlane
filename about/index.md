...
My name is Kin Lane. I am a writer, storyteller, and forever recovering technologist. If you've heard of my name before, you probably know me as [the API Evangelist](http://apievangelist.com/), covering the technology, business, and politics of APIs. 
...
While I thoroughly enjoy writing, I'm having to work hard to find a new voice after being the API Evangelist for so long. I also enjoy taking photos with my multiple cameras, and apply algorithmic filters to them using machine learning models--[algorotoscope](https://algorithmic.rotoscope.work/)--using them in my storytelling across all of my blogs. While videos and photos tell a lot about the world around us, I feel that algorithmically distorted images speak volumes about the world we are experiencing today.
